...
def _write_opencli_descriptor(root: Path) -> dict[str, Any]:
    ...
    payload = {
        ...
        "commands": [
            ...
            {"name": "record_progress", "command": "python second_brain.py note --quiet --summary <summary>"},
            ...
            "Stop": [
                {
                    ...
                    "hooks": [
                        {
                            "type": "command",
                            "command": "python second_brain.py checkpoint --title \"Claude Code 停止前阶段快照\" --summary \"Claude Code 停止前自动保存当前阶段状态\" --quiet",
                        },
                    ],
                },
            ],
